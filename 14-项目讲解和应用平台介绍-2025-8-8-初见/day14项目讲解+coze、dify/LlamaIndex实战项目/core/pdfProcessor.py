        ...
        for text in texts:
            ...
            if text_length == 0:
                ...
                if 'image_paths' in text:
                    ...
                    # 转换json字符串
                    new_paths_json = json.dumps(json.loads(text_chunk['image_paths']) + new_paths) if new_paths else None
    ...
    def create_multimodal_nodes(self, pdf_path: str) -> List[TextNode]:
        ...
        for text in texts:
            doc = TextNode(
                text=text['content'],
                metadata={
                    "image_paths": text['image_paths'] if 'image_paths' in text else None,
