        ...
        if docs_selects:
            ...
            try:
                ...
                for i, source in enumerate(result["sources"], 1):
                    ...
                    if 'image_path' in source['metadata'] and source['metadata']['image_path']:
                        web_safe_image_path = source['metadata']['image_path'].replace(os.sep, '/')
                        # 将图片转为 base64
                        b64_img = self.image_to_base64(web_safe_image_path)
